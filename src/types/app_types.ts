...
export type ProjectState = { video_path: string | null, stt_status: STTStatus, stt_progress: number, translation_status: TranslationStatus, translation_progress: number, results: Array<STTResult>, target_language: string, };
