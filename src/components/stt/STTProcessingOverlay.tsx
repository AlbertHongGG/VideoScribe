...
import { CheckCircle, CircleDashed, Loader2, XCircle, Activity } from "lucide-react";
...
const ProcessingAnimation = () => (
  <div className="relative w-32 h-32 mb-12 mx-auto flex items-center justify-center">
    ...
    <motion.div
      ...
      className="absolute inset-0 rounded-full border-[1.5px] border-dashed border-[#facc15]/30"
    />
    ...
    <motion.div
      ...
      className="absolute inset-3 rounded-full border-[1.5px] border-dotted border-[#facc15]/40"
    />
    ...
    <motion.div
      ...
      className="absolute inset-8 rounded-full bg-[#facc15]/20 blur-md"
    />
    
    {/* Center Icon */}
    <motion.div 
      className="relative z-10 text-[#facc15]"
      animate={{ 
        scale: [1, 1.1, 1],
        filter: [
          "drop-shadow(0px 0px 8px rgba(250,204,21,0.4))", 
          "drop-shadow(0px 0px 16px rgba(250,204,21,0.8))", 
          "drop-shadow(0px 0px 8px rgba(250,204,21,0.4))"
        ] 
      }}
      transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }}
